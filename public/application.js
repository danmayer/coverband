        ...
        .one("load", function() {
          ...
          setTimeout(function() {
            ...
            $.each(["alt", "longdesc", "aria-describedby"], function(i, val) {
              var attr =
                $(settings.el).attr(val) || $(settings.el).attr("data-" + val);
              if (attr) {
...
(function(j, Y, p) {
  ...
  m.oPagination = {
    two_button: {
      ...
      fnUpdate: function(g) {
        if (g.aanFeatures.p)
          for (var l = g.aanFeatures.p, q = 0, r = l.length; q < r; q++)
            if (l[q].childNodes.length !== 0) {
              l[q].childNodes[0].className =
                g._iDisplayStart === 0
                  ? g.oClasses.sPagePrevDisabled
                  : g.oClasses.sPagePrevEnabled;
              l[q].childNodes[1].className =
    ...
    full_numbers: {
      ...
      fnUpdate: function(g, l) {
        if (g.aanFeatures.p) {
          var q = m.oPagination.iFullNumbersShowPages,
            r = Math.floor(q / 2),
          ...
          for (q = r; q <= w; q++)
            C +=
              y != q
                ? '<span class="' + x.sPageButton + '">' + q + "</span>"
                : '<span class="' + x.sPageButtonActive + '">' + q + "</span>";
          w = g.aanFeatures.p;
          var z,
            D = function() {
          ...
          q = 0;
          for (r = w.length; q < r; q++)
            if (w[q].childNodes.length !== 0) {
              z = w[q].childNodes[2];
              z.innerHTML = C;
              j("span", z)
                .click(D)
  ...
  j.fn.dataTable = function(g) {
    ...
    function q(a) {
      return function() {
        var b = [B(this[m.iApiIndex])].concat(
      ...
      if (a.bInitialised === false)
        ...
        if (a.sAjaxSource !== null && !a.oFeatures.bServerSide) {
          ...
          a.fnServerData.call(a.oInstance, a.sAjaxSource, null, function(b) {
            ...
            K(a, false);
            typeof a.fnInitComplete == "function" &&
    ...
    function y(a, b) {
      ...
      if (
        typeof a.aoPreSearchCols[b] == "undefined" ||
    ...
    function w(a, b) {
      ...
      for (var d, f, e = 0; e < b.length; e++) {
        ...
        if (a.aoColumns[e]._bAutoType && a.aoColumns[e].sType != "string") {
          ...
          if (a.aoColumns[e].sType === null) a.aoColumns[e].sType = f;
          else if (a.aoColumns[e].sType != f) a.aoColumns[e].sType = "string";
        }
        if (a.aoColumns[e].bVisible) a.aoData[c].nTr.appendChild(d);
          ...
          for (c = a.aoData.length; b < c; b++) {
            ...
            if (f)
              if (a.aoColumns[h].sType != "string") {
                ...
                if (a.aoColumns[h].sType === null) a.aoColumns[h].sType = s;
                else if (a.aoColumns[h].sType != s)
    ...
    function z(a) {
      ...
      if (a.nTHead.getElementsByTagName("th").length !== 0) {
        ...
        for (d = a.aoColumns.length; b < d; b++) {
          ...
          c.innerHTML = a.aoColumns[b].sTitle;
          if (a.aoColumns[b].bVisible) {
            if (a.aoColumns[b].sClass !== null)
              c.className = a.aoColumns[b].sClass;
            if (a.aoColumns[b].sWidth !== null)
              c.style.width = a.aoColumns[b].sWidth;
            f.appendChild(c);
          }
      ...
      if (a.bJUI) {
        b = 0;
        for (d = a.aoColumns.length; b < d; b++)
          a.aoColumns[b].nTh.insertBefore(
    ...
    function D(a) {
      ...
      if (!(a.oFeatures.bServerSide && !oa(a))) {
        if (a.aiDisplay.length !== 0) {
          ...
          for (i = i; i < h; i++) {
            ...
            if (typeof a.fnRowCallback == "function") {
              o = a.fnRowCallback.call(
                a.oInstance,
                o,
                a.aoData[a.aiDisplay[i]]._aData,
                f,
                i
              );
              if (!o && !e) {
            ...
            if (c !== 0)
              for (k = 0; k < c; k++)
                o == a.aoOpenRows[k].nParent && d.push(a.aoOpenRows[k].nTr);
          }
        } else {
          ...
          e.innerHTML =
            ...
            a.fnRecordsTotal() === 0
              ? a.oLanguage.sEmptyTable
              : a.oLanguage.sZeroRecords.replace(
                  "_MAX_",
        ...
        if (typeof a._bInitComplete == "undefined") {
          ...
          a.nTableWrapper != a.nTable.parentNode &&
            j(a.nTableWrapper).width() > j(a.nTable.parentNode).width() &&
            U(a);
        }
        b = 0;
        for (c = a.aoDrawCallback.length; b < c; b++)
    ...
    function xa(a) {
      ...
      if (a.oScroll.sX === "") {
        ...
        if (j.browser.msie && j.browser.version <= 7)
          a.nTable.style.width = v(
            j(a.nTable).outerWidth() - a.oScroll.iBarWidth
          );
      ...
      if (a.oScroll.sY === "")
        if (j.browser.msie && j.browser.version <= 7)
          d.style.height = v(a.nTable.offsetHeight + a.oScroll.iBarWidth);
    ...
    function Aa(a) {
      for (var b = m.afnFiltering, c = 0, d = b.length; c < d; c++)
    ...
    function Q(a, b) {
      ...
      for (var d = 0, f = b.length; d < f; d++) {
        a.asDataSearch[d] = "";
        for (var e = 0, i = a.aoColumns.length; e < i; e++)
    ...
    function ga(a, b) {
      if (typeof m.ofnSearch[b] == "function") return m.ofnSearch[b](a);
    ...
    function O(a, b) {
      ...
      if (
        ...
        if (Y.runtime) {
          ...
          k =
            "this.ClosureDataTables.fn = function(a,b){var iTest, oSort=this.ClosureDataTables.sort, aoData=this.ClosureDataTables.data;";
      ...
      j(b).click(function(f) {
        if (a.aoColumns[c].bSortable !== false) {
          var e = function() {
            var i, h;
            if (f.shiftKey) {
              for (var k = false, o = 0; o < a.aaSorting.length; o++)
                if (a.aaSorting[o][0] == c) {
                  k = true;
                  i = a.aaSorting[o][0];
                  h = a.aaSorting[o][2] + 1;
                  if (typeof a.aoColumns[i].asSorting[h] == "undefined")
                    a.aaSorting.splice(o, 1);
                  else {
      ...
      for (b = 0; b < i; b++)
        a.aoColumns[b].bSortable &&
          j(a.aoColumns[b].nTh).removeClass(
            h.sSortAsc + " " + h.sSortDesc + " " + a.aoColumns[b].sSortingClass
          );
      f =
        a.aaSortingFixed !== null
          ? a.aaSortingFixed.concat(a.aaSorting)
          ...
          for (b = 0; b < i; b++)
            if (d[b].className.indexOf(e + "1") != -1) {
              ...
              for (a = d.length / i; c < a; c++)
                d[i * c + b].className = d[i * c + b].className.replace(
                  " " + e + "1",
                  ""
                );
    ...
    function Ca(a) {
      if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
        var b = j(a.aanFeatures.i[0]),
          c = a.fnFormatNumber(a.fnRecordsTotal()),
          d = a.fnFormatNumber(a._iDisplayStart + 1),
          f = a.fnFormatNumber(a.fnDisplayEnd()),
          e = a.fnFormatNumber(a.fnRecordsDisplay());
        if (
          a.fnRecordsDisplay() === 0 &&
          a.fnRecordsDisplay() == a.fnRecordsTotal()
        )
          b.html(a.oLanguage.sInfoEmpty + a.oLanguage.sInfoPostFix);
        else if (a.fnRecordsDisplay() === 0)
          b.html(
            a.oLanguage.sInfoEmpty +
              " " +
              a.oLanguage.sInfoFiltered.replace("_MAX_", c) +
          ...
          a.fnRecordsDisplay() == a.fnRecordsTotal()
            ? b.html(
                a.oLanguage.sInfo
                  .replace("_START_", d)
                  .replace("_END_", f)
                  .replace("_TOTAL_", e) + a.oLanguage.sInfoPostFix
              )
            : b.html(
                a.oLanguage.sInfo
                  .replace("_START_", d)
    ...
    function Ga(a) {
      if (a.oFeatures.bStateSave) {
        ...
        c +=
          '"sFilter": "' + a.oPreviousSearch.sSearch.replace('"', '\\"') + '",';
        c += '"sFilterEsc": ' + !a.oPreviousSearch.bRegex + ",";
        c += '"aaSorting": [ ';
        for (b = 0; b < a.aaSorting.length; b++)
          c += "[" + a.aaSorting[b][0] + ",'" + a.aaSorting[b][1] + "'],";
        ...
        for (b = 0; b < a.aoPreSearchCols.length; b++)
          c +=
            "['" +
            a.aoPreSearchCols[b].sSearch.replace("'", "'") +
            "'," +
            !a.aoPreSearchCols[b].bRegex +
            "],";
        c = c.substring(0, c.length - 1);
    ...
    function Ia(a, b) {
      if (a.oFeatures.bStateSave) {
        var c,
          d = ka(a.sCookiePrefix + a.sInstance);
        if (d !== null && d !== "") {
          try {
            c =
    ...
    function Ha(a, b, c, d) {
      ...
      var i;
      if (
        (ka(e) !== null ? p.cookie.length : b.length + p.cookie.length) + 10 >
        4096
      ) {
        e = p.cookie.split(";");
    ...
    function ca(a) {
      ...
      for (i = a.length; d < i; d++) {
        ...
        for (h = a[d].childNodes.length; f < h; f++)
          if (
            a[d].childNodes[f].nodeName.toUpperCase() == "TD" ||
            a[d].childNodes[f].nodeName.toUpperCase() == "TH"
          )
            H.push(a[d].childNodes[f]);
        f = 0;
        for (h = H.length; f < h; f++) {
          var I = H[f].getAttribute("colspan") * 1,
            A = H[f].getAttribute("rowspan") * 1;
          if (!I || I === 0 || I === 1) {
            k = o(b, d, s);
      ...
      for (i = b[0].length; d < i; d++) {
        ...
        for (h = b.length; f < h; f++)
          typeof b[f][d] == "object" && c.push(b[f][d]);
      }
      return c;
    }
    function Ja() {
    ...
    this.fnClose = function(a) {
      for (var b = B(this[m.iApiIndex]), c = 0; c < b.aoOpenRows.length; c++)
    ...
    this.fnGetPosition = function(a) {
      var b = B(this[m.iApiIndex]);
      if (a.nodeName.toUpperCase() == "TR") return R(b, a);
      else if (a.nodeName.toUpperCase() == "TD")
        for (
          var c = R(b, a.parentNode), d = 0, f = 0;
    ...
    this.fnUpdate = function(a, b, c, d, f) {
      ...
      if (typeof a != "object") {
        ...
        c = N(e, c);
        if (c !== null)
          e.aoData[i].nTr.getElementsByTagName("td")[c].innerHTML = b;
      } else {
    ...
    this.fnSetColumnVis = function(a, b) {
      ...
      if (c.aoColumns[a].bVisible != b) {
        ...
        d = 0;
        for (f = c.aoOpenRows.length; d < f; d++)
          c.aoOpenRows[d].nTr.colSpan = T(c);
        U(c);
        D(c);
      }
    };
    ...
    this.fnDestroy = function() {
      ...
      if (a.bJUI) {
        j("th", a.nTHead).removeClass(
          [
            m.oStdClasses.sSortable,
            m.oJUIClasses.sSortableAsc,
            m.oJUIClasses.sSortableDesc,
            m.oJUIClasses.sSortableNone
          ].join(" ")
        );
        ...
        j("th", a.nTHead).removeClass(
          [
            m.oStdClasses.sSortable,
            m.oStdClasses.sSortableAsc,
            m.oStdClasses.sSortableDesc,
            m.oStdClasses.sSortableNone
          ].join(" ")
        );
    ...
    return this.each(function() {
      ...
      if (typeof g != "undefined" && g !== null) {
        ...
        e.oFeatures.bServerSide &&
          ...
          e.aoDrawCallback.push({ fn: W, sName: "server_side_sort_classes" });
      ...
      if (typeof g.aoColumnDefs != "undefined")
        for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
          ...
          for (d = k.length; c < d; c++)
            if (typeof k[c] == "number" && k[c] >= 0) {
              for (; e.aoColumns.length <= k[c]; ) y(e);
              C(e, k[c], g.aoColumnDefs[a]);
            } else if (typeof k[c] == "number" && k[c] < 0)
              C(e, e.aoColumns.length + k[c], g.aoColumnDefs[a]);
            else if (typeof k[c] == "string") {
              b = 0;
              for (f = e.aoColumns.length; b < f; b++)
                if (
                  k[c] == "_all" ||
                  e.aoColumns[b].nTh.className.indexOf(k[c]) != -1
                )
                  C(e, b, g.aoColumnDefs[a]);
            }
        }
      ...
      for (b = e.aaSorting.length; a < b; a++) {
        ...
        if (
          ...
          e.aaSorting[a][1] = f.asSorting[0];
        c = 0;
        for (d = f.asSorting.length; c < d; c++)
          if (e.aaSorting[a][1] == f.asSorting[c]) {
            e.aaSorting[a][2] = c;
            break;
          }
      }
      ...
      if (h) for (a = 0; a < g.aaData.length; a++) w(e, g.aaData[a]);
      else x(e);
...
jQuery.url = (function() {
  ...
  return {
    ...
    segment: function(pos) {
      ...
      return segments[pos] === "" || segments[pos] === undefined
        ? null
        : segments[pos];
    },
